...
| Latest verified deployment | `https://e354e82e.dennis-portfolio-87g.pages.dev` (Phase 21, build of `da940da`; both hosts / Firefox and Chromium; older soft-transition issue remains) |
| Cloudflare Pages project | `dennis-portfolio` |
| Pages production branch argument | `main` |
| Local development | `http://localhost:4321/` |
| Latest delivered assets | `blue-rigged-v6d.glb` (1,200,120 bytes), `blue-v6d-mips.webp` (76,288), `blue-v6d-closed.webp` (2,036); original v6 mesh/rig/atlas, revised sleeping curl, 24 clips. Old v6c filenames removed. Portrait remains `portrait-wide-v2-{1200,640}.webp`. |
