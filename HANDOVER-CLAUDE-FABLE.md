...
| Latest verified deployment | `https://19e4d586.dennis-portfolio-87g.pages.dev` (Blue v6 with curled sleep and bed path, build of `9ac596d`; headless 60 fps live recording clean, checksums match on both hosts) |
