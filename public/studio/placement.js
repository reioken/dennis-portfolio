...
(function (global) {
  ...
  const BRAND_PALETTE = {
    ...
    // Neue Marken: Kicker-Akzent am CI-Rot der echten Logos (#CD1217).
    MASTER_OF_BOARDS: {
      mode: "auto",
      tintHex: "#4A4A4A",
      edgeHex: "#E6E6E6",
      ...
      edgeDark: 68,
      edgeLight: 74,
      headlineLight: "#FAFAFA",
      headlineDark: "#1A1A1A",
      subtitleLight: "#E2E2E2",
      subtitleDark: "#3A3A3A",
      kickerLight: "#E2494D",
      kickerDark: "#CD1217",
    },
    // Werte gespiegelt aus fd_pipeline/brands.py ("Organic Glass"),
    // damit Desktop-App und Studio dasselbe Ergebnis liefern.
    CASA_PURA: {
      mode: "light",
      tintHex: "#88A584",
      edgeHex: "#EDF3E9",
      ...
      edgeDark: 68,
      edgeLight: 80,
      headlineLight: "#F7FAF5",
      headlineDark: "#203329",
      subtitleLight: "#E2EBDE",
      subtitleDark: "#455E4D",
      kickerLight: "#B8D0B2",
      kickerDark: "#66836B",
    },
