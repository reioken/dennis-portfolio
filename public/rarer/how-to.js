import {tiers,tier} from './core.js?v=2e123f57933a';
import {treasureValue} from './rewards.js?v=2e123f57933a';
...
export function visualGuide({help=false,risk=true}={}){
 ...
 <figure class="rarity-demo" aria-label="Example: three progressively rarer answers in the common tier unlock a banking bonus.">
 <div class="demo-label"><span>Example finds</span><span>Rarer →</span></div>
