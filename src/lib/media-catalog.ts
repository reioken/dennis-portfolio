...
export const COLLAGE_DEFAULTS: Record<CollageSlotKey, string> = {
  'img.collage.0': '/media/nexus/screen-home.webp',
  'img.collage.1': '/media/berry/screen-home.webp',
  'img.collage.2': '/media/riftcast/screen-desktop.webp',
  'img.collage.3': '/media/nexus/screen-grid.webp',
  'img.collage.4': '/media/berry/screen-collection.webp',
  'img.collage.5': '/media/riftcast/screen-app.webp',
  'img.collage.6': '/media/floordirekt/screen-pruefen.webp',
  'img.collage.7': '/media/nexus/screen-couch.webp',
};

export const COLLAGE_MEDIA: MediaItem[] = [
  // NEXUS — product UI
  { src: '/media/nexus/screen-home.webp', label: 'Home', group: 'NEXUS' },
  { src: '/media/nexus/screen-home-featured.webp', label: 'Home Featured', group: 'NEXUS' },
  { src: '/media/nexus/screen-grid.webp', label: 'Grid', group: 'NEXUS' },
  { src: '/media/nexus/screen-showcase.webp', label: 'Showcase', group: 'NEXUS' },
  { src: '/media/nexus/screen-coverflow.webp', label: 'Cover Flow', group: 'NEXUS' },
  { src: '/media/nexus/screen-couch.webp', label: 'Couch', group: 'NEXUS' },
  { src: '/media/nexus/screen-couch-featured.webp', label: 'Couch Featured', group: 'NEXUS' },
  { src: '/media/nexus/screen-toplists.webp', label: 'Toplisten', group: 'NEXUS' },
  { src: '/media/nexus/screen-wrapped.webp', label: 'Wrapped', group: 'NEXUS' },
  { src: '/media/nexus/screen-cmdk.webp', label: 'Command Palette', group: 'NEXUS' },
  { src: '/media/nexus/screen-blizzard.webp', label: 'Blizzard Hub', group: 'NEXUS' },
  { src: '/media/nexus/screen-bulk.webp', label: 'Bulk', group: 'NEXUS' },
  ...
  { src: '/media/berry/screen-search.webp', label: 'Search', group: 'Berry' },
  { src: '/media/berry/screen-collection.webp', label: 'Collection', group: 'Berry' },
  { src: '/media/berry/screen-decks-meta.webp', label: 'Decks Meta', group: 'Berry' },
  ...
  { src: '/media/riftcast/screen-desktop-controls.webp', label: 'Desktop Controls', group: 'Riftcast' },
  { src: '/media/riftcast/screen-launcher.webp', label: 'Launcher', group: 'Riftcast' },
  { src: '/media/riftcast/screen-launcher-remote.webp', label: 'Launcher Remote', group: 'Riftcast' },
  ...
  { src: '/media/floordirekt/screen-start.webp', label: 'Start', group: 'Floordirekt' },
  { src: '/media/floordirekt/screen-bilder.webp', label: 'Bilder', group: 'Floordirekt' },
