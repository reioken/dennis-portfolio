...
SHOTS = [('idle', 0, 'three-quarter'), ('idle', 66, 'front'), ('walk', 9, 'side'), ('walk', 27, 'three-quarter'), ('settle', 36, 'three-quarter'),
         ...
         ('sit', 54, 'three-quarter'), ('sitidle', 60, 'side'), ('sitidle', 30, 'front'), ('jumpup', 12, 'side'), ('jumpup', 17, 'side'), ('jumpup', 24, 'side'), ('jumpup', 30, 'side'), ('jumpup', 36, 'side'), ('jumpdown', 10, 'side'), ('jumpdown', 20, 'side'), ('jumpdown', 28, 'side'), ('jumpdown', 32, 'side'),
