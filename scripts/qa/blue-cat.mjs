...
try {
  for(const [width,height,reduce] of [[1440,900,false],[390,844,false],[1440,900,true]]) {
    ...
    assert.deepEqual([...initial.actions].sort(),['arch','bedin','bedout','catch','flick','happy','idle','jumpdown','jumpup','perch','perchidle','playready','pounce','settle','sit','sitarch','sitidle','sleep','stand','swat','swatL','trot','turnL45','turnL90','turnR45','turnR90','unperch','wake','walk']);
