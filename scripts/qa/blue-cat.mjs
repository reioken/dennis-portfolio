...
try {
  for(const [width,height,reduce] of [[1440,900,false],[390,844,false],[1440,900,true]]) {
    ...
    assert.deepEqual([...initial.actions].sort(),['arch','bedin','bedout','flick','happy','idle','jumpdown','jumpup','perch','perchidle','settle','sit','sitarch','sitidle','sleep','stand','trot','turnL45','turnL90','turnR45','turnR90','unperch','wake','walk']);
