...
try {
  for(const [width,height,reduce] of [[1440,900,false],[390,844,false],[1440,900,true]]) {
    ...
    assert.deepEqual([...initial.actions].sort(),['happy','idle','jump','perch','perchidle','settle','sit','sitidle','sleep','stand','turnL45','turnL90','turnR45','turnR90','unperch','wake','walk']);
