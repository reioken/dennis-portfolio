...
| `repair-flow.mjs` | `node scripts/qa/hero/repair-flow.mjs OUT [BASE]` | Delays wear maps and asserts their arrival before shader preparation; checks Mina hardware proxies, close-up, language/history navigation and phone gallery/rotation. |
